...
def main():
    ...
    response = requests.get(
        f"https://api.llama.fi/overview/fees/{Chain}?excludeTotalDataChart=true&excludeTotalDataChartBreakdown=true&dataType={Time}Fees"
    )
    data = response.json()
    ...
    csv_filename = f"{Chain}_{Time}_fee_breakdown.csv"
