...
def get_dex_names_volumes():
    ...
    try:
        ...
        with open("options_dex_names_volumes.csv", "w", newline="") as csvfile:
            ...
            writer.writerow(
                ["name", "display_name", "change_1d", "change_7d", "change_1m", "chain"]
            )
        ...
        print("Data written to options_dex_names_volumes.csv")
